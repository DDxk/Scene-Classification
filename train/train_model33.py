...
def resnet50_100(feat_dims, out_dims):
    ...
    resnet_base_model = ResNet50(include_top=False, weights=None, input_shape=(224, 224, 1))
...
def model_train(model, loadweights, isCenterloss, lambda_center=0.01):
    ...
    if not isCenterloss:
        ...
        history = model.fit_generator(train_generator,
                                      steps_per_epoch=61251 // BATCH_SIZE,
                                      epochs=max_Epochs,
...
if __name__ == "__main__":
    train_path = code_path + 'train1/'
    val_path = code_path + 'validation1/'
    test_image_path = 'data/'
    num_classes = 20
    BATCH_SIZE = 64
    WEIGHTS_PATH = 'best_weights_scene.hdf5'
    max_Epochs = 35
